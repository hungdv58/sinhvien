                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                            <tr>
                                <th width="23%">Mã khóa học cũ</th>
                                <th >Mã khóa học mới</th>

                            </tr>
                            </thead>
                            <tbody>
                            <form method="POST" action="themkh/edit">
                                <?php
                                for ($i=0; $i<count($tenkh); $i++) {
                                    echo '<tr>
                                <td>' . $tenkh[$i] . '</td>
                                <td>';?><input type="text" class="form-control" name="<?php echo $idkh[$i]; ?>"/><?php echo '</td>
                              </tr>';
