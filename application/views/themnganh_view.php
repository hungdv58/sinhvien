        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <tr>
                        <th width="33%">STT</th>
                        <th width="43%">Mã ngành</th>

                      </tr>
                    </thead>
                    <tbody>
                        <form method="POST" name="myform" action="themnganh/export">
                            <fieldset>
                            <?php $i=1;
                            foreach ($nganh as $k =>$val):
                                echo '<tr>
                                <td>'.$i.'</td>
                                <td>'.$val->n_ten.'</td>
                                <td>';?><input type="checkbox" name="chk_group[]" value="<?php echo $val->n_id; ?>" /><?php echo '</td>
                              </tr>';
                            $i++;
                            endforeach;?>
                                </fieldset>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel">Thêm ngành</h4>
                </div>
                <div class="modal-body">
                    <form role="form" method="post" action="themnganh/add" enctype="multipart/form-data" >
                        <div class="box-body">
